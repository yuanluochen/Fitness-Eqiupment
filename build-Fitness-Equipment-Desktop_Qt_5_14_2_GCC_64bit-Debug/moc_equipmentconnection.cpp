...
struct qt_meta_stringdata_equipmentConnection__MontoringEquipmentThread_t {
    QByteArrayData data[5];
    char stringdata0[109];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_equipmentConnection__MontoringEquipmentThread_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_equipmentConnection__MontoringEquipmentThread_t qt_meta_stringdata_equipmentConnection__MontoringEquipmentThread = {
    {
QT_MOC_LITERAL(0, 0, 45), // "equipmentConnection::Montorin..."
QT_MOC_LITERAL(1, 46, 15), // "sendReceivePack"
QT_MOC_LITERAL(2, 62, 0), // ""
QT_MOC_LITERAL(3, 63, 33), // "montoringEquipment::receivePa..."
QT_MOC_LITERAL(4, 97, 11) // "receivePack"

    },
    "equipmentConnection::MontoringEquipmentThread\0"
    "sendReceivePack\0\0montoringEquipment::receivePack_t\0"
    "receivePack"
};
#undef QT_MOC_LITERAL

static const uint qt_meta_data_equipmentConnection__MontoringEquipmentThread[] = {
...
void equipmentConnection::MontoringEquipmentThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<MontoringEquipmentThread *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sendReceivePack((*reinterpret_cast< montoringEquipment::receivePack_t(*)>(_a[1]))); break;
        case 1: _t->receivePack(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (MontoringEquipmentThread::*)(montoringEquipment::receivePack_t );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MontoringEquipmentThread::sendReceivePack)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject equipmentConnection::MontoringEquipmentThread::staticMetaObject = { {
    QMetaObject::SuperData::link<QThread::staticMetaObject>(),
    qt_meta_stringdata_equipmentConnection__MontoringEquipmentThread.data,
    qt_meta_data_equipmentConnection__MontoringEquipmentThread,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
const QMetaObject *equipmentConnection::MontoringEquipmentThread::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->dynamicMetaObject() : &staticMetaObject;
}

void *equipmentConnection::MontoringEquipmentThread::qt_metacast(const char *_clname)
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_equipmentConnection__MontoringEquipmentThread.stringdata0))
        return static_cast<void*>(this);
    return QThread::qt_metacast(_clname);
}

int equipmentConnection::MontoringEquipmentThread::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = QThread::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
...
// SIGNAL 0
void equipmentConnection::MontoringEquipmentThread::sendReceivePack(montoringEquipment::receivePack_t _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
    QMetaObject::activate(this, &staticMetaObject, 0, _a);
}
